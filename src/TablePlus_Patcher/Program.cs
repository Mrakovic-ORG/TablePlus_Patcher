...
namespace TablePlus_Patcher
{
    internal static class Program
    {
        private static readonly string SupposedDirectory = $@"{Environment.ExpandEnvironmentVariables("%ProgramW6432%")}\TablePlus";
        private static readonly string File2Patch = $@"{SupposedDirectory}\TablePlus.exe";
